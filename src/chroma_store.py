...
def _get_embedding_function():
    """Return a ChromaDB-compatible embedding function using a custom wrapper."""
    try:
        ...
        class CustomEmbeddingFunction(EmbeddingFunction):
            def __init__(self, model_name: str):
                ...
                # Force CPU to avoid PyTorch CUDA/meta-device compatibility errors
        ...
        return CustomEmbeddingFunction(model_name=EMBED_MODEL)
